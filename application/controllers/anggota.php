...
public function __construct()
{
 ...
 public function index()
 {
  ...
  // configurasi
  $this->db->like('kode_anggota', $data['keyword']);
  $this->db->or_like('nama', $data['keyword']);
  $this->db->or_like('email', $data['keyword']);
  $this->db->or_like('no_hp', $data['keyword']);
  $this->db->or_like('kemampuan_bahasa', $data['keyword']);
 ...
 public function tambah(){
  $data['kode'] = $this->Anggota_model->kode();
	$data['getAllAnggota'] = $this->Anggota_model->getAllAnggota();
	

  $data['title']='Tambah Data Anggota';
  $this->form_validation->set_rules('kode_anggota', 'Kode', 'required');
  $this->form_validation->set_rules('nama', 'Nama', 'required');
  $this->form_validation->set_rules('email', 'Email', 'required|valid_email');
  $this->form_validation->set_rules('no_hp', 'No. Hp', 'required|numeric');
  $this->form_validation->set_rules('kemampuan_bahasa', 'Kemampuan Bahasa', 'required');
